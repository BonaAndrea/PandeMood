Shader "Simple Toon/SToon Outline"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "AutoLight.cginc"
            #include "STCore.cginc"
            #include "Lighting.cginc" //added for light color intensity
			...
			fixed4 frag (v2f i) : SV_Target
            {
				...
				fixed4 shadecol = _DarkColor;
				fixed4 litcol = ColorBlend(_Color, _LightColor0, _AmbientCol);
				fixed4 texcol = tex2D(_MainTex, i.uv) * litcol * _ColIntense * _LightColor0 + _ColBright; //added _LightColor0: intensity of light
